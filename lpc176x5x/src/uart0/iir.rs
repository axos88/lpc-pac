...
impl INTID_R {
    ...
    #[doc = "Checks if the value of the field is `_2B_CHARACTER_TIME`"]
    #[inline(always)]
    pub fn is_2b_character_time(&self) -> bool {
        *self == INTIDR::_2B_CHARACTER_TIME
    }
